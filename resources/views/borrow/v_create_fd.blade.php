...
<div class="row">
    <div class="col">
        <form action="{{ route('borrow.storeFd') }}" method="POST">
            @csrf
            {{-- @method('POST') --}}
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('nik') is-invalid @enderror" placeholder="Input your Employee ID" name="nik" value="{{ old('nik') }}"  onkeyup="autoFill()" autofocus>
                        @error('nik')                   
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('asset') is-invalid @enderror" name="asset" aria-label="Default select example">
                            ...
                            @if ($assets->isEmpty())
                            <option value="">all flashdik is being borrowed</option>
                            @endif   
                        </select>
                        @error('asset')                   
